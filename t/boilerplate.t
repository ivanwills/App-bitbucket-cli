...
module_boilerplate_ok('lib/App/BitBucketCli/Command/PullRequests');
module_boilerplate_ok('lib/App/BitBucketCli/Command/Repositories');
module_boilerplate_ok('lib/App/BitBucketCli/Command/Repository');
module_boilerplate_ok('lib/App/BitBucketCli/Command/Projects');
module_boilerplate_ok('lib/App/BitBucketCli/Command/Branches');
done_testing();
