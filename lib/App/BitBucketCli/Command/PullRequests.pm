...
App::BitBucketCli::Command::PullRequests - <One-line description of module's purpose>

=head1 VERSION

This documentation refers to App::BitBucketCli::Command::PullRequests version 0.0.1


=head1 SYNOPSIS

   use App::BitBucketCli::Command::PullRequests;
...
Return: App::BitBucketCli::Command::PullRequests -
